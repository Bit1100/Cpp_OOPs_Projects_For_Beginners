...
public:
    ...
    Student(int roll, const string &sname) : roll_no(roll), name(sname)
    {
...
public:
    Test() {}
    // Intialization List in Constructor
    Test(float m1, float m2) : marks1(m1), marks2(m2)
    {
...
public:
    ExtraCurriculum() {}
    // Intialization List in Constructo
    ExtraCurriculum(float s) : score(s)
    {
...
public:
    Result() {}
    // Intialization List in Constructor
    Result(int roll, const string &sname, float m1, float m2, float score) : Test(m1, m2), ExtraCurriculum(score), Student(roll, sname), total(0), percentage(0)
    {
